          ...
          <div class="space-y-2 px-4 pb-3">
            @for (hint of hints(); track hint.message) {
              <div
                ...
                [class.bg-[var(--accent-muted)]]="hint.type === 'info'"
                [class.border-[var(--accent)]]="hint.type === 'info'"
                [class.text-[var(--accent-hover)]]="hint.type === 'info'"
              ...
              >
                ...
                @if (hint.action) {
                  <button
                    ...
                    [class.bg-[var(--accent)]]="hint.type === 'info'"
                    [class.hover:bg-[var(--accent-hover)]]="hint.type === 'info'"
