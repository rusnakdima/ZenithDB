...
import {
  ...
  DatabaseListResult,
} from "@services/services.decentralization-api.service";
import {
  CollectionsApiService,
  CollectionListResult,
} from "@services/services.collections-api.service";
import { CACHE_CONSTANTS } from "@shared/utils/constants";
import { evictLRUInPlace } from "@shared/utils/cache.utils";
import { ConnectionCacheService } from "@shared/services/core/connection-cache.service";
import { CollectionCacheService } from "@shared/services/core/collection-cache.service";
import { QueryCacheService } from "@shared/services/core/storage-query.service";
...
export class DataStoreService {
  ...
  updateHealth(
    connectionId: string,
    health: import("@entities/entities.connection.config").ConnectionHealth
  ): void {
