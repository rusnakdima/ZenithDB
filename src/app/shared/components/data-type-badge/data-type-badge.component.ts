...
export class DataTypeBadgeComponent {
  ...
  private readonly _typeMap: Record<string, TypeConfig> = {
    ...
    number: { icon: "#", colorClass: "text-emerald-400" },
    integer: { icon: "#", colorClass: "text-emerald-400" },
    decimal: { icon: "#", colorClass: "text-emerald-400" },
    float: { icon: "#", colorClass: "text-emerald-400" },
    boolean: { icon: "T/F", colorClass: "text-orange-400" },
