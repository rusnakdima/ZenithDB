...
import { IndexDefinition } from "@shared/models/index-definition.model";
...
export class ApiProvider {
  ...
  async createIndex(connId: string, collection: string, indexDef: IndexDefinition): Promise<void> {
    const startTime = performance.now();
